...
public enum RaceLapValidationStatus
{
    Verified,
...
public sealed record RaceErrorPayload(
    string Code,
    string Message,
    int? RetryAfterSeconds = null);
...
public sealed record RaceLapAcknowledgement(
    ...
    bool IsAccepted,
    string? Message = null,
    RaceLapValidationStatus? ValidationStatus = null);
...
public sealed record RacePreRaceCheckWarning(
    string Code,
    string Message,
    IReadOnlyList<Guid> ParticipantIds);

public sealed record RacePreRaceCheckReport(
    DateTimeOffset GeneratedAt,
    IReadOnlyList<RacePreRaceCheckWarning> Warnings,
    bool CanForceStart);
